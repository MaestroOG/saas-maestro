...
const formSchema = z.object({
    ...
    duration: z.coerce.number().min(1, { message: 'topic is required.' }),
})
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 mb-8">
                        ...
                        <FormItem>
                            ...
                            <FormControl>
                                <Select onValueChange={field.onChange} value={field.value} defaultValue={field.value}>
                                    <SelectTrigger className="input capitailize">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>What should tje companion help with?</FormLabel>
                            <FormControl>
